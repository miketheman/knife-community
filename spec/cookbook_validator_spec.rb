...
describe KnifeCommunity::CookbookValidator do
  ...
  describe '#initialize' do
    ...
    it 'fails when not all arguments have been passed' do
      expect { KnifeCommunity::CookbookValidator.new(@cookbook_name, cookbook_path) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '#validate!' do
    it 'returns an error when specifying existing version' do
      ...
      expect { cv.validate! }.to raise_error(Chef::Exceptions::InvalidCookbookVersion)
    end
    ...
    it 'returns an error when specifying a non-existing cookbook' do
      ...
      expect { cv.validate! }.to raise_error(Chef::Exceptions::CookbookNotFoundInRepo)
    end
  end
end
